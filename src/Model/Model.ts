...
export class Model implements ModelInterface {
        ...
        observer.subscribe(this.modelName, (data: any, actionName?: string) => {
            if (data !== 'Start Processing' && data !== 'Session expired!') {
                switch (actionName) {
                    ...
                    case 'updateManyRaw':
                    case 'deleteManyRaw':
                        this.actionGetItems(this.modelName, 'socket');
                        break;
     ...
     */
    async actionGetMetadata(microserviceName: string, connectionType: string) {
